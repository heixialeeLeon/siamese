...
train_dataset = PairData("/data_1/data/signatureCompare/gaochao/data_1224/train", "/data_1/data/signatureCompare/gaochao/data_1224/train.list", "/data_1/data/signatureCompare/gaochao/data_1224/train_p.list", has_class = True)
...
#scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, [6, 9], gamma=0.1)
